...
const InteractiveBanner = (props) => {
  ...
  return (
    <div className='lg:w-[66%] w-full card-zoom'>
          <div className={`mainBlock border border-violet-300 rounded-lg group bg-cover bg-center transition-all ease-in hover:ease-out m-4 justify-end min-h-[19.5rem] p-[2rem] flex`} style={{ backgroundImage: props.background }} id={props.id}>
